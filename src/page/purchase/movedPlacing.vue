    ...
    <div class="module-box">
        ...
        <div class="search-box">
            <el-form ref="form" inline size="small">
                ...
                <div>
                    <el-form-item label-width="100px" label="单据状态：">
                        <el-select v-model="value" filterable placeholder="请选择">
                            <el-option value="1" label="仓库1"></el-option>
                            <el-option value="0" label="仓库2"></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label-width="100px" label="制单人：">
                        <el-select v-model="value" filterable placeholder="请选择">
                            <el-option value="1" label="仓库1"></el-option>
                            <el-option value="0" label="仓库2"></el-option>
                        </el-select>
        ...
        <el-table style="width: 100%" :data="queryData">
            <el-table-column prop="date" align="center" label="单据号" width="220">
                <template slot-scope="scope">
                    <p>SQC180813151616406778</p>
                </template>
            </el-table-column>
            <el-table-column prop="date" align="center" label="单据状态" width="150">
                <template slot-scope="scope">
                    <p>批准</p>
                </template>
            </el-table-column>
            <el-table-column prop="date" align="center" label="收货门店" width="150">
                <template slot-scope="scope">
                    <p>舜泰广场</p>
                </template>
            </el-table-column>
            <el-table-column prop="date" align="center" label="发货仓库" width="150">
                <template slot-scope="scope">
                    <p>绿源</p>
                </template>
            </el-table-column>
            <el-table-column prop="date" align="center" label="要货申请单号" width="150">
                <template slot-scope="scope">
                    <p>SQC180813151616406778</p>
                </template>
            </el-table-column>
            <el-table-column prop="date" align="center" label="制单时间" width="210">
                <template slot-scope="scope">
                    <p>2018-03-31 15:31:20</p>
                </template>
            </el-table-column>
            <el-table-column prop="date" align="center" label="出库时间" width="210">
                <template slot-scope="scope">
                    <p>2018-03-31 15:31:21</p>
                </template>
            </el-table-column>
