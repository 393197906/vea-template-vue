<template>
    <div class="module-box">
        <el-button
                type="primary"
                size="small"
                @click="$router.push({path: '/stock/inventory/newInventory'})"
                class="return-goods-btn">新建盘点</el-button>
        <!-- 搜索 -->
        <div class="search-box">
            <el-form ref="form" inline size="small">
                ...
                <div>
                    <el-form-item label-width="100px" label="盘点单号：">
                        <el-input></el-input>
                    </el-form-item>
        ...
        <el-table style="width: 100%" :data="queryData">
            ...
            <el-table-column prop="date" align="center" label="仓库" width="200">
                <template slot-scope="scope">
                    <p>测试仓库</p>
                </template>
            </el-table-column>
            <el-table-column prop="date" align="center" label="出库类型" width="200">
                <template slot-scope="scope">
                    <p>已完成</p>
                </template>
            </el-table-column>
            <el-table-column prop="date" align="center" label="制单时间" width="200">
                <template slot-scope="scope">
                    <p>2018-08-15 20:43:17</p>
                </template>
            </el-table-column>
            <el-table-column prop="date" align="center" label="操作人" width="200">
                <template slot-scope="scope">
                    <p>ldjbenben</p>
                </template>
            </el-table-column>
            ...
            <el-table-column prop="date" align="center" label="操作">
                <template slot-scope="scope">
                    <el-button size="mini" type="primary" @click="$router.push({path: '/stock/inventory/inventoryInfo'})">详情</el-button>
                </template>
            </el-table-column>
        </el-table>
        <!-- // 表格 -->
