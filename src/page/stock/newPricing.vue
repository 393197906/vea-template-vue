    ...
    <div>
        ...
        <!-- 商品信息 slot="selectGoods" -->
            <div slot="selectGoods">
                ...
                <el-table style="width: 100%" :data="queryData">
                    ...
                    <el-table-column prop="date" align="center" label="调整前成本价(元)" width="200"></el-table-column>
                    <el-table-column prop="date" align="center" label="调整后成本价(元)" width="200"></el-table-column>
                    <el-table-column prop="date" align="center" label="差异(元)" width="200"></el-table-column>
        ...
        <!-- 底部按钮 slot="footerButton" -->
            <div slot="footerButton">
                <el-button type="primary" size="small">确认调价</el-button>
            </div>
        </detailsFrame>
