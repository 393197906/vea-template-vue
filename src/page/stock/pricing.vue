<template>
    <div class="module-box">
        <el-button
                type="primary"
                size="small"
                @click="$router.push({path: '/stock/pricing/newPricing'})"
                class="return-goods-btn">新建成本调价</el-button>
        <!-- 搜索 -->
        ...
        <el-table style="width: 100%" :data="queryData">
            ...
            <el-table-column prop="date" align="center" label="调价金额(元)" width="200">
                <template slot-scope="scope">
            ...
            <el-table-column prop="date" align="center" label="操作">
                <template slot-scope="scope">
                    <el-button size="mini" type="primary" @click="$router.push({path: '/stock/pricing/pricingInfo'})">详情</el-button>
                </template>
            </el-table-column>
        </el-table>
        <!-- // 表格 -->
